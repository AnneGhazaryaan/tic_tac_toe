...
void MainWindow::announce(const QString& gameState)
{
    if (gameState == "1w2l") {
        ...
        QMessageBox::information(this, "Player 1","You win!");
        disableAllButtons();
    } else if (gameState == "1l2l") {
        qDebug() << "It's a draw!";
        QMessageBox::about(this, "Player 1","It's a draw!");
        disableAllButtons();
    } else if (gameState == "1l2w") {
        qDebug() << "Player 1 lose!";
        QMessageBox::critical(this, "Player 1","You lose!");
        disableAllButtons();
    }
}
